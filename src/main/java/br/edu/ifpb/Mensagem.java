...
public class Mensagem {
    ...
    public void reprovado(){
        System.out.println("Não é possivel doar sangue.");
    }
    public void aprovado(Doador d){
        System.out.println(d.getNome() + ", você foi aprovado para doar sangue! Por favor, aguarde na fila de doação!");
    }
    ...
    public void doadorMaiorSessentaENDoador(){
        System.out.print("Doador com idade maior que 60 anos que nunca doou sangue anteriormente!");
    }
